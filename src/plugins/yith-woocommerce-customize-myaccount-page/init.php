 ...
 * Description: YITH WooCommerce Customize My Account Page lets you customize the layout of the "My Account" page.
 * Version: 2.2.0
 * Author: YITHEMES
...
function yith_wcmap_install_woocommerce_admin_notice() {
	?>
	<div class="error">
		<p><?php _e( 'YITH WooCommerce Customize My Account Page is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-customize-myaccount-page' ); ?></p>
	</div>
	<?php
}
...
if ( ! defined( 'YITH_WCMAP_VERSION' ) ){
	define( 'YITH_WCMAP_VERSION', '2.2.0' );
}
