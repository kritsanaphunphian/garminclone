...
function wcmca_reset_input_text_fields()
{
	...
	jQuery( '.wcmca_input_field' ).css( { 'border': '1px solid #ddd' } );
	jQuery( '.select2-selection' ).css( { 'border': '1px solid #ddd' } );
...
function wcmca_validate_fields_before_sending(type)
{
	//UI
	jQuery(".wcmca_error").fadeOut();
	jQuery( '#wcmca_address_form_container_' + type + ' .validation-message' ).remove();

	jQuery( '#wcmca_address_form_container_' + type + ' .wcmca_input_field' ).css( { 'border': '1px solid #ddd' } );
	jQuery( '#wcmca_address_form_container_' + type + ' .select2-selection' ).css( { 'border': '1px solid #ddd' } );
	...
	formData.append('email', jQuery('#wcmca_'+type+'_email').length ? jQuery('#wcmca_'+type+'_email').val() : 'no_validation');
	formData.append('postcode', jQuery('#wcmca_'+type+'_postcode').length ? jQuery('#wcmca_'+type+'_postcode').val() : 'no_validation' );
	formData.append('phone', jQuery('#wcmca_'+type+'_phone').length ? jQuery('#wcmca_'+type+'_phone').val() : 'no_validation');
	formData.append('country', jQuery('#wcmca_'+type+'_country').length ? jQuery('#wcmca_'+type+'_country').val() : '');
	formData.append('type', type);
