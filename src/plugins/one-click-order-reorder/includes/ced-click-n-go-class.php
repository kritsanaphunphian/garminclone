...
if( ! class_exists( 'Ced_Click_n_Go' ) ) {
	class Ced_Click_n_Go {
		...
		public function __construct() {
			 ...
			 */
			add_action ( 'wp_ajax_get_order_products', array( $this, CNG_PREFIX . '_get_order_products' ) );
			add_action ( 'wp_ajax_nopriv_get_order_products', array( $this, CNG_PREFIX . '_get_order_products' ) );
		 ...
		 * @author CedCommerce
		 */
		function ced_cng_get_order_products() {
			...
			foreach( $order->get_items() as $product_info ) {
				...
				/**
				 * Returns products using WC_Product_Factory class.
				 */
		 ...
		 *
		 * Handles Ajax Request and Fetches Previous orders done By a user,
