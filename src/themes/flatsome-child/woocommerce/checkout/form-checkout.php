<?php
/**
 * @see wp-content/themes/flatsome/woocommerce/checkout/form-checkout.php
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
if ( ! $checkout->enable_signup && ! $checkout->enable_guest_checkout && ! is_user_logged_in() ) {
    echo '<div class="garminbygis-wc-checkout-must-be-logged-in-message">';
...
// Social login
if ( flatsome_option( 'facebook_login_checkout' ) && 'yes' == get_option( 'woocommerce_enable_myaccount_registration' ) && ! is_user_logged_in() ) {
