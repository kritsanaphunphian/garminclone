 ...
 *
 * @see wp-content/themes/flatsome/woocommerce/content-product.php
 */
...
// Check stock status
$out_of_stock = 'outofstock' == get_post_meta( $post->ID, '_stock_status', true );
    ...
    <div class="col-inner">
        ...
        <div class="product-small box <?php echo flatsome_product_box_class(); ?>">
            <div class="box-image">
                ...
                <?php if ( $out_of_stock ) : ?>
                    <div class="out-of-stock-label"><?php _e( 'Out of stock', 'woocommerce' ); ?></div>
                <?php endif; ?>
            </div><!-- box-image -->
